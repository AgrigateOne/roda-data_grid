...
class ListGridConfigTest < Minitest::Test
  ...
  def test_multiselect
    additions = { multiselect: { multitest: { grid_caption: 'Multi caption', url: '/d/e/f' } } }
    config = Crossbeams::DataGrid::ListGridConfig.new(id: 'agrid', root_path: '/a/b/c', params: { key: 'multitest', athing: 'athing' }, multi_key: 'multitest', config_loader: loader_extended(additions))
